...
#Had to manually copy out the kinase list from here: 
#  https://www.promega.com/resources/guides/kinase-target-engagement-assay-selection-table/
#
#htmltab didn't work for this page.

dark_NanoBRET_assays <- read_csv(here('NanoBRET/kinases_from_Promega.csv')) %>%
  clean_names() %>%
...
#lots of repeats in the current list from promega, probably good as they are
#picking up the reagents, but need to remove them from the list for our site
dark_NanoBRET_assays = dark_NanoBRET_assays %>% 
  filter(! symbol %in% tracer_info$symbol)
